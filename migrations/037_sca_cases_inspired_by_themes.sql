...
Your task is to take a focused history, address her concerns, and formulate an appropriate management plan.',
...
Your task is to discuss the results, take a focused history, and formulate an appropriate management plan.',
...
Your task is to take a focused history, address concerns, and formulate an appropriate management plan.',
...
Your task is to take a focused history, assess severity, and formulate an appropriate management plan.',
